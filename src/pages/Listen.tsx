...
export default function Listen() {
  ...
  useEffect(() => {
    supabase.from("tracks_public").select("id,slug,title,artist_name,artist_slug,cover_url,duration_seconds,price_standard_cents,price_gold_cents,price_download_cents,pct_free,pct_standard,pct_gold,is_active,sort_order").eq("is_active", true)
