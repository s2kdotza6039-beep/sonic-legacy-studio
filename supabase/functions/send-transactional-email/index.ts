...
const SITE_NAME = "sonic-legacy-studio"
...
Deno.serve(async (req) => {
  ...
  // Reject anon callers. Only the founder UI (CeoOutbox) or the service role
  // (process-email-queue / triggers) may send mail through this function.
